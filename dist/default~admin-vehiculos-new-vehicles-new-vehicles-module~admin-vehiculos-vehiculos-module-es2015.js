...
const routes = [{ path: "", component: _new_vehicles_component__WEBPACK_IMPORTED_MODULE_3__["NewVehiclesComponent"] }];
let NewVehiclesRoutingModule = class NewVehiclesRoutingModule {
};
...
let NewVehiclesComponent = class NewVehiclesComponent {
    constructor(fb, categoriaService, vehicleService, router) {
        var _a, _b;
        this.fb = fb;
...
NewVehiclesComponent.ctorParameters = () => [
...
let NewVehiclesModule = class NewVehiclesModule {
};
...
let VehiclesInfoBasicService = class VehiclesInfoBasicService {
    constructor(afs) {
        this.afs = afs;
...
//# sourceMappingURL=default~admin-vehiculos-new-vehicles-new-vehicles-module~admin-vehiculos-vehiculos-module-es2015.js.map
...
var routes = [
    ...
    { path: 'listar', loadChildren: function () { return Promise.all(/*! import() | list-client-list-client-module */[__webpack_require__.e("default~admin-marcas-marcas-module~admin-modelos-modelos-module~admin-vehiculos-vehiculos-module~adm~3b92aaa7"), __webpack_require__.e("list-client-list-client-module")]).then(__webpack_require__.bind(null, /*! ./list-client/list-client.module */ "./src/app/layout/components/modules/clientes/list-client/list-client.module.ts")).then(function (m) { return m.ListClientModule; }); } },
];

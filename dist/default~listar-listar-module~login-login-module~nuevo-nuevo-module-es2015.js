(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~listar-listar-module~login-login-module~nuevo-nuevo-module"],{
...
let UserServiceService = class UserServiceService {
    ...
    onDeleteUserAdmin(userid) {
        return new Promise((resolve, reject) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                const result = yield this.usercollectionAdmin.doc(userid).delete();
                resolve(result);
            }
            catch (error) {
                reject(error.message);
    ...
    onSaveUserAdmin(user, userId) {
        return new Promise((resolve, reject) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                const id = userId || this.afs.createId();
                const data = Object.assign({ id }, user);
                const result = yield this.usercollectionAdmin.doc(id).set(data);
                resolve(result);
            }
            catch (error) {
                reject(error.message);
    ...
    getUsersAdmin() {
        this.userAdmin = this.usercollectionAdmin.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => actions.map(a => a.payload.doc.data())));
    }
    getUserByIdAdmin(id) {
        return this.afs.collection(('usersAdmin'), ref => ref.where('id', '==', id)).valueChanges();
    }
    validateuserAdmin(email) {
        return this.afs.collection(('usersAdmin'), ref => ref.where('email', "==", email)).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => actions.map(a => a)));
    }
};
...
//# sourceMappingURL=default~listar-listar-module~login-login-module~nuevo-nuevo-module-es2015.js.map
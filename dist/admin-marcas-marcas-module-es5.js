...
var routes = [];
var ListMarcasRoutingModule = /** @class */ (function () {
    function ListMarcasRoutingModule() {
    }
    ...
    return ListMarcasRoutingModule;
}());
...
var ListMarcasComponent = /** @class */ (function () {
    function ListMarcasComponent(marcaService, dialog, fb, categoriaService) {
        var _this = this;
        this.marcaService = marcaService;
        this.dialog = dialog;
        this.fb = fb;
    ...
    ListMarcasComponent.prototype.ngOnInit = function () {
    };
    ListMarcasComponent.prototype.onEditar = function (id, editmodal, marca, categoria) {
        this.marcaeditid = id;
        this.initForm();
        marca != null ? this.marcaForm.get('name').setValue(marca) : "";
        categoria != null ? this.marcaForm.get('category').setValue(categoria) : "";
    ...
    ListMarcasComponent.prototype.openDeleteModal = function (deleteModal, marcaId, marca) {
        this.deletemarca = marca;
        this.marcaDeleteid = marcaId;
        this.dialog.open(deleteModal);
    };
    ListMarcasComponent.prototype.initForm = function () {
        this.marcaForm = this.fb.group({
            name: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]),
            category: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required])
        });
    };
    ListMarcasComponent.prototype.onGuardar = function (marcaId, modal) {
        this.dialog.open(modal);
        this.marcaService.onSaveMarca(this.marcaForm.value, marcaId);
    };
    ListMarcasComponent.prototype.onEliminar = function (id) {
        var _this = this;
        this.isloading = true;
        this.icon = false;
        this.marcaService.onDeleteMarca(id).then(function (resp) {
    ...
    ListMarcasComponent.ctorParameters = function () { return [
        { type: src_app_services_marcas_service__WEBPACK_IMPORTED_MODULE_5__["MarcasService"] },
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModal"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: src_app_services_categorias_service__WEBPACK_IMPORTED_MODULE_4__["CategoriasService"] }
...
var ListMarcasModule = /** @class */ (function () {
    function ListMarcasModule() {
    }
...
var routes = [{ path: "", component: _marcas_component__WEBPACK_IMPORTED_MODULE_3__["MarcasComponent"] }];
var MarcasRoutingModule = /** @class */ (function () {
    function MarcasRoutingModule() {
    }
...
var MarcasModule = /** @class */ (function () {
    function MarcasModule() {
    }
...
var routes = [];
var NewMarcasRoutingModule = /** @class */ (function () {
    function NewMarcasRoutingModule() {
    }
...
var NewMarcasComponent = /** @class */ (function () {
    function NewMarcasComponent(marcaService, fb, categoriaService, dialog) {
        var _this = this;
        this.marcaService = marcaService;
        this.fb = fb;
        this.categoriaService = categoriaService;
    ...
    NewMarcasComponent.prototype.ngOnInit = function () {
    };
    NewMarcasComponent.prototype.onGuardar = function (modal) {
    ...
    NewMarcasComponent.prototype.initForm = function () {
        this.marcaForm = this.fb.group({
            category: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]),
            name: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required])
        });
    };
    NewMarcasComponent.ctorParameters = function () { return [
        { type: src_app_services_marcas_service__WEBPACK_IMPORTED_MODULE_5__["MarcasService"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: src_app_services_categorias_service__WEBPACK_IMPORTED_MODULE_4__["CategoriasService"] },
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModal"] }
...
var NewMarcasModule = /** @class */ (function () {
    function NewMarcasModule() {
    }
...
//# sourceMappingURL=admin-marcas-marcas-module-es5.js.map
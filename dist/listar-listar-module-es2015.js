...
let ListarComponent = class ListarComponent {
    ...
    onVer(element) {
        ...
        const dialogRef = this.dialog.open(src_app_admin_modals_user_user_component__WEBPACK_IMPORTED_MODULE_6__["UserComponent"], {
            width: '300px',
            data: {
                user: {
                    name: element.name,
    ...
    onDelete(id) {
        const dialogref = this.dialog.open(src_app_admin_modals_confirmacion_confirmacion_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmacionComponent"], {
            width: '250px',
            data: {

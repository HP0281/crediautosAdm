...
var routes = [];
var ListModelosRoutingModule = /** @class */ (function () {
    function ListModelosRoutingModule() {
    }
    ...
    return ListModelosRoutingModule;
}());
...
var ListModelosComponent = /** @class */ (function () {
    function ListModelosComponent(modelosService, dialog, fb, marcaService, categoriaService) {
        var _this = this;
    ...
    ListModelosComponent.prototype.ngOnInit = function () {
        this.initForm();
    };
    ListModelosComponent.prototype.openEditModal = function (id, modal, marca, modelo, category) {
    ...
    ListModelosComponent.prototype.openDeleteModal = function (id, modal) {
        this.idactual = id;
        this.dialog.open(modal);
    };
    ListModelosComponent.prototype.onGuardar = function () {
        if (this.modeloform.valid) {
            this.modelosService.onSaveModelo(this.modeloform.value, this.idactual);
        }
    };
    ListModelosComponent.prototype.onEliminar = function () {
        this.modelosService.onDeleteModelo(this.idactual);
    };
    ListModelosComponent.prototype.initForm = function () {
    ...
    ListModelosComponent.ctorParameters = function () { return [
...
var ListModelosModule = /** @class */ (function () {
    function ListModelosModule() {
    }
...
var routes = [{ path: "", component: _modelos_component__WEBPACK_IMPORTED_MODULE_3__["ModelosComponent"] }];
var ModelosRoutingModule = /** @class */ (function () {
    function ModelosRoutingModule() {
    }
...
var ModelosComponent = /** @class */ (function () {
    function ModelosComponent() {
    }
    ModelosComponent.prototype.ngOnInit = function () {
    };
...
var ModelosModule = /** @class */ (function () {
    function ModelosModule() {
    }
...
var routes = [{ path: "", component: _new_modelos_component__WEBPACK_IMPORTED_MODULE_3__["NewModelosComponent"] }];
var NewModelosRoutingModule = /** @class */ (function () {
    function NewModelosRoutingModule() {
    }
    ...
    return NewModelosRoutingModule;
}());
...
var NewModelosComponent = /** @class */ (function () {
    function NewModelosComponent(fb, marcaService, modelosService, categoriaService) {
        var _this = this;
        this.fb = fb;
        this.marcaService = marcaService;
        this.modelosService = modelosService;
    ...
    NewModelosComponent.prototype.ngOnInit = function () {
    };
    NewModelosComponent.prototype.initForm = function () {
        this.modeloForm = this.fb.group({
            category: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
            marca: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]),
            name: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required])
    ...
    NewModelosComponent.prototype.onGuardar = function () {
        if (this.modeloForm.valid) {
            this.modelosService.onSaveModelo(this.modeloForm.value, null);
        }
    };
    NewModelosComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
...
var NewModelosModule = /** @class */ (function () {
    function NewModelosModule() {
    }
...
//# sourceMappingURL=admin-modelos-modelos-module-es5.js.map
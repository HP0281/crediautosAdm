...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router, auth, fb, userSv, dialog) {
        this.router = router;
        this.auth = auth;
        this.fb = fb;
        this.userSv = userSv;
    ...
    LoginComponent.prototype.onLoggedin = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                this.auth.login(this.acces.get('user').value, this.acces.get('psw').value).then(function (resp) {
                    _this.userSv.validateuserAdmin(_this.acces.get('user').value).subscribe(function (resp) {
                        if (resp[0] != null) {
                            window.sessionStorage.setItem("auth", JSON.stringify(_this.user));
                    ...
                    var dialogref = _this.dialog.open(_admin_modals_confirmacion_confirmacion_component__WEBPACK_IMPORTED_MODULE_5__["ConfirmacionComponent"], {
                        width: '250px',
                        data: {
                            message: err,
                            noresp: true,
    ...
    LoginComponent.prototype.googleAuth = function () {
        ...
        this.auth.getUser().subscribe(function (resp) {
            _this.user = resp;
            window.sessionStorage.setItem("auth", JSON.stringify(_this.user));
            console.log("JSON.stringify(this.user)", JSON.stringify(_this.user));

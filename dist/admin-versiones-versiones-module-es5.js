...
var routes = [{ path: "", component: _list_versiones_component__WEBPACK_IMPORTED_MODULE_3__["ListVersionesComponent"] }];
var ListVersionesRoutingModule = /** @class */ (function () {
    function ListVersionesRoutingModule() {
    }
    ...
    return ListVersionesRoutingModule;
}());
...
var ListVersionesModule = /** @class */ (function () {
    function ListVersionesModule() {
    }
...
var NewVersionesRoutingModule = /** @class */ (function () {
    function NewVersionesRoutingModule() {
    }
    ...
    return NewVersionesRoutingModule;
}());
...
var NewVersionesComponent = /** @class */ (function () {
    function NewVersionesComponent(fb, marcaService, modeloService, versionService, categoriService) {
        var _this = this;
        this.fb = fb;
        ...
        this.modeloService.modelos.subscribe(function (resp) {
            _this.modelos = resp;
        });
        this.categoriService.categories.subscribe(function (resp) {
            _this.categories = resp;
        });
        this.initForm();
    }
    NewVersionesComponent.prototype.ngOnInit = function () {
    };
    NewVersionesComponent.prototype.initForm = function () {
    ...
    NewVersionesComponent.prototype.onGuardar = function () {
        if (this.versionForm.valid) {
            this.versionService.onSaveVersion(this.versionForm.value, null);
        }
    };
    NewVersionesComponent.ctorParameters = function () { return [
...
var NewVersionesModule = /** @class */ (function () {
    function NewVersionesModule() {
    }
...
var routes = [{ path: "", component: _versiones_component__WEBPACK_IMPORTED_MODULE_3__["VersionesComponent"] }];
var VersionesRoutingModule = /** @class */ (function () {
    function VersionesRoutingModule() {
    }
...
var VersionesModule = /** @class */ (function () {
    function VersionesModule() {
    }
...
//# sourceMappingURL=admin-versiones-versiones-module-es5.js.map
...
var NuevoProductoRoutingModule = /** @class */ (function () {
    function NuevoProductoRoutingModule() {
    }
    ...
    return NuevoProductoRoutingModule;
}());
...
var NuevoProductoComponent = /** @class */ (function () {
    function NuevoProductoComponent(fb, vehicleService, router, auth, categoryService, marcasService, modelosService, versionService, _storage) {
        var _a, _b;
        this.fb = fb;
    ...
    NuevoProductoComponent.prototype.onCategory = function (category) {
        this.category = category;
        this.onContinue('category');
    };
    NuevoProductoComponent.prototype.onMarca = function (marca) {
        this.marca = marca;
        this.onContinue('marca');
    };
    NuevoProductoComponent.prototype.onModelo = function (modelo) {
        this.modelo = modelo;
        this.onContinue('modelo');
    };
    NuevoProductoComponent.prototype.onYear = function (year) {
        this.year = year;
        this.onContinue('año');
    };
    NuevoProductoComponent.prototype.onVersion = function (version) {
        this.version = version;
    };
    NuevoProductoComponent.prototype.llenarformularios = function () {
    ...
    NuevoProductoComponent.prototype.initForm = function () {
    ...
    NuevoProductoComponent.prototype.asignarvalue = function (nomvar, valor) {
        switch (nomvar) {
            case 'unicodue':
    ...
    NuevoProductoComponent.prototype.patchvalues = function () {
    ...
    NuevoProductoComponent.prototype.getCategories = function () {
        var _this = this;
    ...
    NuevoProductoComponent.prototype.getMarcas = function () {
        var _this = this;
        this.marcasService.marcas.subscribe(function (resp) {
            _this.marcas = resp;
        });
    };
    NuevoProductoComponent.prototype.getModelos = function (marca) {
        var _this = this;
        console.log('resultado marcas');
        this.modelosService.getModelosforMarca(marca).subscribe(function (resp) {
            console.log(resp);
            _this.modelos = resp;
        });
    };
    NuevoProductoComponent.prototype.getVersions = function (marca, modelo) {
        var _this = this;
        this.versionService.getVersionesforMarcaModelo(marca, modelo).subscribe(function (resp) {
            _this.versions = resp;
        });
    };
    NuevoProductoComponent.prototype.getVehicles = function (id) {
        this.vehicleService.getVehiclesById(id).subscribe(function (resp) {
            console.log(resp);
        });
    };
    NuevoProductoComponent.prototype.initYears = function () {
        var yearact = 2022;
    ...
    NuevoProductoComponent.prototype.uploadImg = function (event) {
        var _this = this;
        var file = event.target.files[0];
        var randomId = Math.random().toString(36).substring(2);
        var filepath = "images/" + randomId;
        var fileref = this._storage.ref(filepath);
        var task = this._storage.upload(filepath, file);
        this.uploadProgress = task.percentageChanges();
        task.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["finalize"])(function () {
            _this.uploadURL = fileref.getDownloadURL();
            _this.cargo = true;
            _this.uploadURL.subscribe(function (resp) {
                _this.asignarvalue('urlimg', resp);
            });
        })).subscribe();
        this.onContinue('img');
    };
    NuevoProductoComponent.prototype.back = function (opt) {
        switch (opt) {
            case 'marca':
                this.progreso = 2;
                break;
...
var NuevoProductoModule = /** @class */ (function () {
    function NuevoProductoModule() {
    }
...
//# sourceMappingURL=nuevo-producto-nuevo-producto-module-es5.js.map
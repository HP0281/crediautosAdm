...
const routes = [];
let ListlMarcasMotosRoutingModule = class ListlMarcasMotosRoutingModule {
};
...
let ListlMarcasMotosComponent = class ListlMarcasMotosComponent {
...
ListlMarcasMotosComponent.ctorParameters = () => [
...
let ListlMarcasMotosModule = class ListlMarcasMotosModule {
};
...
const routes = [];
let ListTipoCamionRoutingModule = class ListTipoCamionRoutingModule {
};
...
let ListTipoCamionComponent = class ListTipoCamionComponent {
    constructor(marcaService, dialog, fb, categoriaService) {
        this.marcaService = marcaService;
        this.dialog = dialog;
        this.fb = fb;
...
ListTipoCamionComponent.ctorParameters = () => [
    { type: src_app_services_marcas_service__WEBPACK_IMPORTED_MODULE_5__["MarcasService"] },
    { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModal"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: src_app_services_categorias_service__WEBPACK_IMPORTED_MODULE_4__["CategoriasService"] }
...
let ListTipoCamionModule = class ListTipoCamionModule {
};

...
var routes = [{ path: "", component: _versiones_list_versiones_list_versiones_component__WEBPACK_IMPORTED_MODULE_3__["ListVersionesComponent"] }];
var ListVehiclesRoutingModule = /** @class */ (function () {
    function ListVehiclesRoutingModule() {
    }
    ...
    return ListVehiclesRoutingModule;
}());
...
var ListVehiclesComponent = /** @class */ (function () {
    function ListVehiclesComponent(vehiclesService, router) {
        var _this = this;
        ...
        this.vehiclesService.vehicles.subscribe(function (resp) {
            _this.data = resp;
        });
    }
    ListVehiclesComponent.prototype.ngOnInit = function () {
    };
    ListVehiclesComponent.prototype.onEditar = function (item) {
        this.navigationExtras.state.value = item;
        this.router.navigate(['editar/vehicle'], this.navigationExtras);
    };
    ListVehiclesComponent.prototype.onVer = function (item) {
        this.navigationExtras.state.value = item;
        this.router.navigate(['ver/vehicle'], this.navigationExtras);
    };
    ListVehiclesComponent.prototype.onEliminar = function () {
    };
    ListVehiclesComponent.ctorParameters = function () { return [
...
var ListVehiclesModule = /** @class */ (function () {
    function ListVehiclesModule() {
    }
...
var routes = [{ path: "", component: _vehiculos_component__WEBPACK_IMPORTED_MODULE_3__["VehiculosComponent"] }];
var VehiculosRoutingModule = /** @class */ (function () {
    function VehiculosRoutingModule() {
    }
...
var VehiculosModule = /** @class */ (function () {
...
//# sourceMappingURL=admin-vehiculos-vehiculos-module-es5.js.map
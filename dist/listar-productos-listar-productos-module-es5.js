...
var ListarProductoRoutingModule = /** @class */ (function () {
    function ListarProductoRoutingModule() {
    }
    ...
    return ListarProductoRoutingModule;
}());
...
var ListarProductosComponent = /** @class */ (function () {
    function ListarProductosComponent(router, vehicleService, serviceModal) {
        this.router = router;
    ...
    ListarProductosComponent.prototype.ActivarProducto = function (producto) {
        if (confirm("esta seguro de Activar?")) {
            producto.estadoProducto = "Activo";
        }
    };
    ListarProductosComponent.prototype.promocion = function (event, cambiandoModal) {
        console.log(event);
    ...
    ListarProductosComponent.prototype.status = function (vehicle, modal) {
        vehicle.status = !vehicle.status;
        this.vehicleService.onSaveVehicle(vehicle, vehicle.id);
        this.serviceModal.open(modal);
        this.loaderEstado = true;
    };
    ListarProductosComponent.prototype.inactivarProducto = function (producto) {
    ...
    ListarProductosComponent.prototype.cargarProductos = function () {
        ...
        this.vehicleService.vehicles.subscribe(function (data) {
            _this.vehicles = data;
            _this.loader = false;
            console.log("data", data);
        });
    };
    ListarProductosComponent.prototype.cargarImagenes = function () {
    };
    ...
    ListarProductosComponent.prototype.isEmpresa = function () {
    };
    ListarProductosComponent.ctorParameters = function () { return [
...
var ListarProductosModule = /** @class */ (function () {
    function ListarProductosModule() {
    }
...
var ListarProductoPipe = /** @class */ (function () {
    function ListarProductoPipe() {
    }
    ListarProductoPipe.prototype.transform = function (value, arg) {
        var resultProducto = [];
        for (var _i = 0, value_1 = value; _i < value_1.length; _i++) {
            var producto = value_1[_i];
...
//# sourceMappingURL=listar-productos-listar-productos-module-es5.js.map
...
var ListarComponent = /** @class */ (function () {
    function ListarComponent(router, serviceModal, userService) {
        this.router = router;
    ...
    ListarComponent.prototype.ngOnInit = function () {
        this.userService.user.subscribe(function (resp) {
            //this.categories = resp;
            console.log("resp", resp);
        });
    };
    ListarComponent.prototype.editarUsuario = function (usuario) {
        localStorage.setItem("id_usuario", usuario.id + "");
        this.router.navigate(["usuario/editar"]);
    };
    ListarComponent.prototype.borrarUsuario = function (usuario) {
        if (confirm('¿Estás seguro?')) {
        }
    };
    ListarComponent.prototype.inactivarUsuario = function (usuario) {
        //usuario.rol.id = this.getIdRol();
    };
    ListarComponent.prototype.activarUsuario = function (usuario) {
    };
    ListarComponent.prototype.cambiarEstadoDomiciliarioDisp = function (usuario, modal) {
        this.serviceModal.open(modal);
    };
    ListarComponent.prototype.cambiarEstadoDomiciliarioNoDisp = function (usuario, modal) {
        this.serviceModal.open(modal);

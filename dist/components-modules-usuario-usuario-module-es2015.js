...
const routes = [
    { path: '', component: _usuario_component__WEBPACK_IMPORTED_MODULE_3__["UsuarioComponent"],
        children: [
            ...
            { path: 'listar', loadChildren: () => __webpack_require__.e(/*! import() | listar-listar-module */ "listar-listar-module").then(__webpack_require__.bind(null, /*! ./listar/listar.module */ "./src/app/layout/components/modules/usuario/listar/listar.module.ts")).then(m => m.ListarModule) },
            { path: 'nuevo', loadChildren: () => __webpack_require__.e(/*! import() | nuevo-nuevo-module */ "nuevo-nuevo-module").then(__webpack_require__.bind(null, /*! ./nuevo/nuevo.module */ "./src/app/layout/components/modules/usuario/nuevo/nuevo.module.ts")).then(m => m.NuevoModule) },

...
var NuevoRoutingModule = /** @class */ (function () {
    function NuevoRoutingModule() {
    }
...
var NuevoComponent = /** @class */ (function () {
    function NuevoComponent(router) {
        this.router = router;
    ...
    NuevoComponent.prototype.cargarEmpresas = function () {
    };
    NuevoComponent.prototype.cargarRoles = function () {
    };
    NuevoComponent.prototype.esEmailValido = function (email) {
    ...
    NuevoComponent.prototype.capturar = function () {
    ...
    NuevoComponent.prototype.capturarEmpresa = function () {
    };
    NuevoComponent.prototype.guardarUsuario = function () {
    };
    NuevoComponent.prototype.validadorNombre = function (event) {
        var pattern = /^[a-zA-Z ]*$/;
    ...
    NuevoComponent.prototype.getEmpresa = function () {
    };
    NuevoComponent.prototype.guardarCaja = function () {
    };
    NuevoComponent.prototype.getidSesion = function () {
    };
    NuevoComponent.prototype.getIdRol = function () {
    };
...
var NuevoModule = /** @class */ (function () {
    function NuevoModule() {
    }
...
//# sourceMappingURL=nuevo-nuevo-module-es5.js.map
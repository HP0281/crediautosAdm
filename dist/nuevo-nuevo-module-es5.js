...
var NuevoComponent = /** @class */ (function () {
    function NuevoComponent(fb, userservice, authservice, dialog) {
        this.fb = fb;
    ...
    NuevoComponent.prototype.initform = function () {
    ...
    NuevoComponent.prototype.onRegistrar = function (email, pass) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var error_1, dialogref;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.authservice.registrar(email, pass)];
                    case 1:
                        _a.sent();
                        this.onGuardar();
                    ...
                    case 2:
                        error_1 = _a.sent();
                        dialogref = this.dialog.open(src_app_admin_modals_confirmacion_confirmacion_component__WEBPACK_IMPORTED_MODULE_4__["ConfirmacionComponent"], {
                            width: '250px',
                            data: {
    ...
    NuevoComponent.prototype.onGuardar = function () {
        if (this.registroForm.valid) {
            var user = this.registroForm.value;
            console.log(user);
            var userid = null;
            this.userservice.onSaveUserAdmin(this.registroForm.value);
        }
    };
    NuevoComponent.prototype.getErrorMessage = function () {

...
const routes = [{ path: '', component: _categorias_component__WEBPACK_IMPORTED_MODULE_3__["CategoriasComponent"] }];
...
const routes = [{ path: '', component: _list_category_component__WEBPACK_IMPORTED_MODULE_3__["ListCategoryComponent"] }];
let ListCategoryRoutingModule = class ListCategoryRoutingModule {
};
...
let ListCategoryComponent = class ListCategoryComponent {
    constructor(categoryService, dialog, fb) {
    ...
    onEliminar(id) {
        this.isloading = true;
        this.icon = false;
        this.categoryService.onDeleteCategory(id).then(resp => {
            this.isloading = false;
            this.icon = true;
        });
    }
...
let NewCategoryRoutingModule = class NewCategoryRoutingModule {
};
...
let NewCategoryComponent = class NewCategoryComponent {
    constructor(categoryService, fb, dialog) {
        this.categoryService = categoryService;
        this.fb = fb;
        this.dialog = dialog;
        this.initForm();
...
let NewCategoryModule = class NewCategoryModule {
};
...
//# sourceMappingURL=admin-categorias-categorias-module-es2015.js.map
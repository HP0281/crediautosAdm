...
var ListClientRoutingModule = /** @class */ (function () {
    function ListClientRoutingModule() {
    }
    ...
    return ListClientRoutingModule;
}());
...
var ListClientComponent = /** @class */ (function () {
    function ListClientComponent(userSv, dialog) {
        var _this = this;
        this.userSv = userSv;
        this.dialog = dialog;
        this.userSv.user.subscribe(function (resp) {
            _this.clientes = resp;
        });
    }
    ListClientComponent.prototype.ngOnInit = function () {
    };
    ListClientComponent.prototype.vehicles = function (id) {
    };
    ListClientComponent.ctorParameters = function () { return [
...
var ListClientModule = /** @class */ (function () {
    function ListClientModule() {
    }
...
//# sourceMappingURL=list-client-list-client-module-es5.js.map